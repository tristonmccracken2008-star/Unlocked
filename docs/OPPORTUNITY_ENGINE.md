...
The catalog currently contains three types: `Benefit`, `AI`, and `Career`. Existing benefit, school, AI, and career interfaces are projections over this catalog. They must not introduce separate content records.
