...
export function buildOpportunityStudentContext(profile: AdvisorProfile): OpportunityStudentContext {
  ...
  return {
    ...
    secondaryMajor: profile.academics.secondaryMajor,
    minor: profile.academics.minor,
    academicYear: profile.academics.academicYear,
    careerGoals: unique([profile.goals.careerGoal, ...profile.goals.specificCareerInterests]).join(", "),
    ...
    currentGoals: profile.goals.primaryGoals,
