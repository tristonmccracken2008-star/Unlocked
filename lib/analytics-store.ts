...
const useMemoryStore = process.env.UNLOCKED_ANALYTICS_STORE === "memory";
const kvUrl = useMemoryStore ? undefined : process.env.KV_REST_API_URL ?? process.env.UPSTASH_REDIS_REST_URL;
const kvToken = useMemoryStore ? undefined : process.env.KV_REST_API_TOKEN ?? process.env.UPSTASH_REDIS_REST_TOKEN;
