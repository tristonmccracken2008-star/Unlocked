...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = ["", "/ai", "/career", "/research", "/scholarships", "/software", "/benefits", "/financial", "/local", "/about", "/contact", "/privacy", "/disclaimer", "/submit-perk", "/opportunities", "/best-edu-email-perks", "/student-discounts", "/free-student-software", "/student-ai-tools"];
  return [
