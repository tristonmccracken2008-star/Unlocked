  ...
  return <main className="bg-paper px-5 py-14 sm:px-8">
    <section className="mx-auto max-w-6xl">
      ...
      <div className="mt-10 grid gap-5 rounded-[1.5rem] bg-white/72 p-6 ring-1 ring-ink/8 lg:grid-cols-2">
        <section><h2 className="font-editorial text-2xl font-bold">Free includes</h2><ul className="mt-4 space-y-2 text-sm leading-6 text-ink/58"><li>Discover, search, filters, and opportunity pages</li><li>Add opportunities and update progress in Journey</li><li>Journey dates in Opportunity Planner</li><li>Journey Card image export and sharing</li><li>Limited For You preview</li></ul></section>
        <section><h2 className="font-editorial text-2xl font-bold">Pro includes</h2><ul className="mt-4 space-y-2 text-sm leading-6 text-ink/58"><li>Your full For You shortlist</li><li>Year Ahead planning from matches and Watch</li><li>New matches and deadline updates</li><li>Matches shaped by your Journey</li><li>Dark mode and premium appearance</li></ul></section>
      </div>
