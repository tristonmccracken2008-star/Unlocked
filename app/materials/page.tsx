...
export default async function MaterialsPage() {
  ...
  try {
    ...
    return <ApplicationMaterials initial={buildApplicationMaterialsModel({ account: session.data, opportunities })} guidance={normalizeGuidanceState(session.data.guidance)} />;
  } catch (error) {
