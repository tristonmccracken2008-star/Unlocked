    ...
    <>
      ...
      <section className="border-b border-ink/15 bg-white">
        <div className="mx-auto grid max-w-7xl sm:grid-cols-[120px_1fr_260px]">
          ...
          <div className="border-b border-ink/15 px-5 py-10 sm:border-b-0 sm:px-8"><p className="rule-label text-forest">Verified university student hub · {school.domain}</p><h1 className="mt-3 font-editorial text-4xl font-bold sm:text-5xl">{school.name}</h1><p className="mt-4 text-sm leading-6 text-ink/45">{school.location} · {nationalCount} national benefits · {schoolSpecificCount} school-specific benefits</p><p className="mt-2 text-xs font-bold text-ink/35">Last updated {lastUpdated}</p></div>
