...
export default async function Page({params}:{params:Promise<{id:string}>}){
  ...
  const related=getRelatedOpportunities(item,12,catalog).filter((candidate)=>candidate.verification_status==="verified").slice(0,4);
