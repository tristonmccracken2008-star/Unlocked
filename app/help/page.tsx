...
export default function Page() {
  return <InfoPage eyebrow="Help" title="How UnlockED works" intro="A practical guide to using UnlockED and understanding the trust signals on each listing.">
    ...
    <section><h2>Frequently asked questions</h2><h3>Do I need an account?</h3><p>No. You can browse public opportunities without signing in. An account lets you sync your profile, saved opportunities, and tracker across devices.</p><h3>Does UnlockED decide eligibility?</h3><p>No. Eligibility is determined by the official provider, university, employer, or sponsor.</p><h3>Why do some values say unknown?</h3><p>UnlockED shows unknown when the official source does not publish a fixed dollar value. We avoid inventing values that cannot be verified.</p><h3>How do I report outdated information?</h3><p>Use the report-outdated control on opportunity detail pages or contact support@unlockededu.com with the official source link and what changed.</p></section>
  </InfoPage>;
}
