...
export const metadata = publicPageMetadata("Help", "Learn what UnlockED is, how recommendations work, how verification works, and answers to common questions.", "/help");
...
export default function Page() {
  return <InfoPage eyebrow="Help" title="How UnlockED works" intro="A practical guide to using UnlockED and understanding the trust signals on each listing.">
    ...
    <section><h2>Frequently asked questions</h2><h3>Do I need an account?</h3><p>Yes. Sign in to browse opportunities, save your profile, and keep your Journey synced across devices.</p><h3>Does UnlockED decide eligibility?</h3><p>No. Eligibility is determined by the official provider, university, employer, or sponsor.</p><h3>Why do some values say unknown?</h3><p>UnlockED shows unknown when the official source does not publish a fixed dollar value. We avoid inventing values that cannot be verified.</p><h3>How do I report outdated information?</h3><p>Use the report-outdated control on opportunity detail pages or email support@unlockededu.com with the official source link and what changed.</p></section>
  </InfoPage>;
}
