...
export function CareerExplorer() {
  ...
  const [visible, setVisible] = useState(24); const [filtersOpen, setFiltersOpen] = useState(false);
  ...
  return <main className={`${styles.page} application-studio-theme`} data-careers-explorer>
    <div className={styles.shell}>
      <header className={styles.hero}><div><p className="rule-label text-forest">Discover · United States</p><h1>Explore careers</h1><p>{searchCareers().length} paths. Compare the work, pay, entry routes, and outlook.</p></div><Link href="/careers#methodology">Sources & methodology</Link></header>
