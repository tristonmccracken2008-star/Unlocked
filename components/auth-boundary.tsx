...
export function AuthBoundary({children}:{children:React.ReactNode}){
  ...
  if(!session?.authenticated||(requiresProfile&&!profile))return <main className="min-h-[65vh] px-5 py-16 sm:px-8"><div className="mx-auto max-w-5xl"><p className="rule-label text-forest">UnlockED</p><h1 className="mt-3 font-editorial text-3xl font-bold">Loading your account...</h1><p className="mt-3 text-sm text-ink/45">Checking your session and saved profile.</p></div></main>;
  return children;
}
