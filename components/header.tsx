...
export function Header() {
  ...
  if(!session?.authenticated)return <header className="border-b border-ink/15 bg-paper"><div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-5 px-5 sm:px-8"><Logo/><AccountButton compact/></div></header>;
