...
export function PrintResume({ model, resume }: { model: ResumeLabModel; resume: ResumeDocumentView }) {
  ...
  return <main className={styles.page}><div className={styles.toolbar}><a href="/resume-lab">Back to Resume Lab</a><button type="button" onClick={() => { trackProductEvent("resume_export_opened_v1", { format: "print" }); window.print(); }}>Print or save as PDF</button></div><article className={styles.paper}>
