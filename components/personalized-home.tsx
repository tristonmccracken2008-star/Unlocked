  ...
  return <main className="bg-paper">
    <section className="border-b border-ink/15 px-5 py-16 sm:px-8 sm:py-20">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
        <div>
          <p className="rule-label text-forest">Built for students</p>
    ...
    <section className="px-5 py-12 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-5 grid gap-px bg-ink/15 md:grid-cols-3">{["Sign in with Google.","Tell us your school, major, and goals.","Start with the opportunities that fit."].map((step,index)=><article key={step} className="bg-white p-6"><span className="font-mono text-xs font-bold text-ink/30">{String(index+1).padStart(2,"0")}</span><h2 className="mt-4 font-editorial text-2xl font-bold">{step}</h2></article>)}</div>
      </div>
    </section>
