...
const localCommands: CommandResult[] = [
  ...
  { id: "navigate:applications", kind: "navigate", group: "Navigate", title: "Applications", subtitle: "Review active applications and open a packet for detailed preparation.", href: "/applications", score: 0, keywords: "my applications application workspace packet what do i need to finish tasks requirements" },
  ...
  { id: "learn:applications", kind: "learn", group: "Learn UnlockED", title: "Applications and Application Packets", subtitle: "Learn how the overview and one-application preparation view fit together.", href: "/learn#applications", score: 0, keywords: "application workspace packet tasks help resume" },
