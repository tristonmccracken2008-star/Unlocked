...
export function OpportunityCard({ opportunity }: { opportunity: Opportunity }) {
  const secondary = opportunity.type === "Career" || opportunity.type === "Research" ? deadlineLabel(opportunity) : opportunity.type === "Benefit" ? opportunity.metadata.valueLabel ?? "Value unknown" : opportunity.metadata.studentOffer ?? "See official source";
  const secondaryLabel = opportunity.type === "Career" || opportunity.type === "Research" ? "Deadline" : opportunity.type === "Benefit" ? "Estimated value" : "Student access";
