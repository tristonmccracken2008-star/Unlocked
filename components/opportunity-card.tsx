...
export function OpportunityCardContent({ opportunity, reasons, source }: { opportunity: OpportunityListing; reasons?: string[]; source?: "discover" | "for_you" }) {
  ...
  return <article data-ui-card="" data-discover-opportunity={source === "discover" ? opportunity.id : undefined} style={{ color: "var(--unlocked-text)", background: "var(--unlocked-surface)", borderColor: "var(--unlocked-border)" }} className="flex h-full flex-col rounded-[1.25rem] border p-5 shadow-[0_14px_40px_rgba(43,33,26,.05)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_20px_48px_rgba(43,33,26,.085)] motion-reduce:hover:translate-y-0">
