...
export function OpportunityCard({ opportunity }: { opportunity: Opportunity }) {
  const secondary = opportunity.type === "Career" ? deadlineLabel(opportunity) : opportunity.type === "Benefit" ? opportunity.metadata.valueLabel ?? "Value unknown" : opportunity.metadata.studentOffer ?? "See official source";
  const secondaryLabel = opportunity.type === "Career" ? "Deadline" : opportunity.type === "Benefit" ? "Estimated value" : "Student access";
