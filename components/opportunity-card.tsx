...
export function OpportunityCardContent({ opportunity, reasons, source }: { opportunity: OpportunityListing; reasons?: string[]; source?: "discover" | "for_you" }) {
  ...
  return <article data-ui-card="" data-discover-opportunity={source === "discover" ? opportunity.id : undefined} style={{ color: "var(--unlocked-text)", background: "var(--unlocked-surface-subtle)", borderColor: "transparent" }} className="group flex h-full flex-col rounded-[1.1rem] border p-4 transition duration-200 hover:border-forest/20 hover:bg-[var(--unlocked-surface-elevated)] focus-within:border-forest/30 focus-within:bg-[var(--unlocked-surface-elevated)] sm:p-5">
