...
try {
  ...
  assert.equal(await mobilePage.locator("[data-accomplishments]").evaluate((element) => getComputedStyle(element).color), "rgb(241, 243, 242)", "The record must inherit the active dark-theme text token.");
