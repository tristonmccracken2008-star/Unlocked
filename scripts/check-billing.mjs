...
for (const token of ["getEntitlementsForBilling", "canViewRecommendationExplanations"]) {
...
assert.ok(forYou.includes("new matches, deadline updates, and recommendations shaped by your Journey"), "For You must explain tangible recurring Pro value rather than only more recommendations.");
