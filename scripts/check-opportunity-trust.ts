...
assert.match(page, /trust\.eligibility/);
assert.match(page, /Requirements haven’t been verified yet/);
assert.match(page, /View official source/);
assert.doesNotMatch(page, /label="Confidence"/);
