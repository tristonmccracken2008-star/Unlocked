...
assert.match(center, /ProfileIdentityCard/, "The account center must render the private identity projection.");
assert.match(center, /Profile settings\./, "The editable profile area must have one clear heading.");
assert.doesNotMatch(center, /Your account, clearly organized|The facts that shape your matches|Update your profile\./, "The Profile hierarchy must not repeat overlapping headings.");
