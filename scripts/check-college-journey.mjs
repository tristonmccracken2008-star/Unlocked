...
for (const token of ["Download PNG", "navigator.share", "navigator.clipboard", "ClipboardItem", "serializeBrandedArtwork", "canvas.toBlob", "Private by default"]) assert.ok(creator.includes(token), `Path Moment creator must include ${token}.`);
