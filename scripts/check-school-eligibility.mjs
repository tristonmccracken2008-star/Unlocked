...
assert.match(snapshot, /forYouSnapshotEngineVersion = "for-you-snapshot-v9-opportunity-intelligence"/, "Snapshot engine version must invalidate snapshots generated before the server-authoritative opportunity briefing.");
