...
assert.match(snapshot, /forYouSnapshotEngineVersion = "for-you-snapshot-v11-opportunity-briefing"/, "Snapshot engine version must invalidate snapshots generated before the server-authoritative opportunity briefing.");
