...
assert.match(snapshot, /forYouSnapshotEngineVersion = "for-you-snapshot-v8-first-session-preview"/, "Snapshot engine version must invalidate snapshots generated before the first-session free preview.");
