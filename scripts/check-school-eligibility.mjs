...
assert.match(snapshot, /forYouSnapshotEngineVersion = "for-you-snapshot-v6-opportunity-intelligence"/, "Snapshot engine version must invalidate snapshots generated before the premium opportunity-intelligence view model.");
