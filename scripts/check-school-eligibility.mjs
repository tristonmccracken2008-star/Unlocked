...
assert.match(snapshot, /forYouSnapshotEngineVersion = "for-you-snapshot-v10-decision-intelligence"/, "Snapshot engine version must invalidate snapshots generated before server-authoritative decision intelligence.");
