...
assert.match(snapshot, /forYouSnapshotEngineVersion = "for-you-snapshot-v7-premium-portfolio"/, "Snapshot engine version must invalidate snapshots generated before the premium For You portfolio.");
