...
for (const section of ["Your private record of what you saved, pursued, and accomplished.", "Needs attention", "Active opportunities", "Professional history", "Journey Cards"]) assert.ok(commandCenter.includes(section), `Journey command center must include ${section}.`);
