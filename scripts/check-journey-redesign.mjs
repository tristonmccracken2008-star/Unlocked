...
const liveLine = readFileSync("components/journey-live-line.tsx", "utf8");
...
assert.ok(editorial.includes("JourneyResponsiveLine") && liveLine.includes("JourneyLiveLine") && liveLine.includes("OpenLineMotionRenderer"), "The Journey must render the existing responsive Open Line motion system.");
assert.ok(editorial.includes("The moments that shaped your path"), "Journey history must remain available below the opening composition.");
