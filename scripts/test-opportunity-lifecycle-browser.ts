...
<article class="card" data-state="open"><span class="badge" aria-label="Applications open; confirmed">Applications open</span><h2>Open program</h2><a class="action" href="https://example.edu/apply">View official application</a></article>
<article class="card" data-state="upcoming"><span class="badge" aria-label="Opening soon; strong evidence">Opening soon</span><h2>Upcoming program</h2><a class="action secondary" href="https://example.edu">View official source</a></article>
