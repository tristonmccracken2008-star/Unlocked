...
<article class="card" data-state="open"><span class="badge" aria-label="Applications open; confirmed">Applications open</span><h2>Open program</h2><section data-recent-updates><h3>Recent updates</h3><time datetime="2027-05-15T12:00:00.000Z">May 15, 2027</time><strong>Deadline extended</strong><p>Jun 15, 2027 → Jul 1, 2027</p></section><a class="action" href="https://example.edu/apply">View official application</a></article>
<article class="card" data-state="upcoming"><span class="badge" aria-label="Opening soon; strong evidence">Opening soon</span><h2>Upcoming program</h2><section data-empty-updates hidden><h3>Recent updates</h3></section><a class="action secondary" href="https://example.edu">View official source</a></article>
